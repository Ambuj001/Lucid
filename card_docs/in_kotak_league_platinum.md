...
The **Kotak League Platinum** is a premium **Credit** card issued by **Kotak Mahindra Bank** running on the **MASTERCARD** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹500.00 + GST
- **Annual Fee:** ₹500.00 + GST
- **Annual Fee Spend Waiver Threshold:** Spends exceeding ₹50,000.00 in the previous card anniversary year waive the subsequent year's fee.
...
| Dining, Restaurants & Food Delivery | `5812` | **2.0%** | No Cap |

### ⚠️ Crucial Terms and Marketing Gimmicks
- 2 reward points per Rs.150 spent (0.5% yield).
- 🍔 8 reward points per Rs.150 on Dining.
