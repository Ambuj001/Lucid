# SBI Global Contactless Debit

The **SBI Global Contactless Debit** is a premium **Debit** card issued by **State Bank of India** running on the **MASTERCARD** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹0.00 + GST
- **Annual Fee:** ₹125.00 + GST
