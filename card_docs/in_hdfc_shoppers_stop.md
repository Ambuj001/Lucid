...
The **Shoppers Stop HDFC** is a premium **Credit** card issued by **HDFC Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹299.00 + GST
- **Annual Fee:** ₹299.00 + GST
- **Annual Fee Spend Waiver Threshold:** Spends exceeding ₹25,000.00 in the previous card anniversary year waive the subsequent year's fee.
