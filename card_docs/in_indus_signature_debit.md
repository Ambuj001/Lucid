...
The **IndusInd Signature Debit** is a premium **Debit** card issued by **IndusInd Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹1,500.00 + GST
- **Annual Fee:** ₹1,500.00 + GST
