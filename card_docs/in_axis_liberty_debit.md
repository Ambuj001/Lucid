...
The **Axis Liberty Debit** is a premium **Debit** card issued by **Axis Bank** running on the **MASTERCARD** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹200.00 + GST
- **Annual Fee:** ₹200.00 + GST
