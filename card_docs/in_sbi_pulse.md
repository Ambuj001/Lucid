...
The **SBI Pulse** is a premium **Credit** card issued by **State Bank of India** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹1,499.00 + GST
- **Annual Fee:** ₹1,499.00 + GST
- **Annual Fee Spend Waiver Threshold:** Spends exceeding ₹200,000.00 in the previous card anniversary year waive the subsequent year's fee.
...
| Dining, Restaurants & Food Delivery | `5812` | **1.25%** | No Cap |
| Pharmacy & Medical Stores | `5912` | **1.25%** | No Cap |
| Movie Theatres & OTT / Streaming | `7832` | **1.25%** | No Cap |
...
- 🍔 5X points (1.25% yield) on Dining spends.
- 💊 5X points (1.25% yield) on Pharmacy/Chemist spends.
- 🎬 5X points (1.25% yield) on Movies spends.
