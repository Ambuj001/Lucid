...
The **Amex Centurion Card** is a premium **Credit** card issued by **American Express** running on the **AMEX** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹700,000.00 + GST
- **Annual Fee:** ₹250,000.00 + GST
