...
The **IndusInd Pioneer Heritage** is a premium **Credit** card issued by **IndusInd Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹90,000.00 + GST
- **Annual Fee:** ₹90,000.00 + GST
