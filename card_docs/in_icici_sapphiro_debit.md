...
The **ICICI Sapphiro Debit** is a premium **Debit** card issued by **ICICI Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹1,999.00 + GST
- **Annual Fee:** ₹1,999.00 + GST
...
| Airlines & Flights | `4511` | **1.0%** | No Cap |

### ⚠️ Crucial Terms and Marketing Gimmicks
- 4 reward points per Rs.200 (0.5% yield).
- ✈️ 8 points per Rs.200 (1.0% yield) on international spends.
