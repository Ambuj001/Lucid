...
The **Axis Reserve** is a premium **Credit** card issued by **Axis Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹50,000.00 + GST
- **Annual Fee:** ₹50,000.00 + GST
- **Annual Fee Spend Waiver Threshold:** Spends exceeding ₹2,500,000.00 in the previous card anniversary year waive the subsequent year's fee.
