# HDFC EasyShop Classic Debit

The **HDFC EasyShop Classic Debit** is a premium **Debit** card issued by **HDFC Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹150.00 + GST
- **Annual Fee:** ₹150.00 + GST
