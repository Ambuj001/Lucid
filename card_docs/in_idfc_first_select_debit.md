# IDFC First Select Debit

The **IDFC First Select Debit** is a premium **Debit** card issued by **IDFC First Bank** running on the **VISA** network. Below are the verified fee structures, reward policies, exclusions, and card terms.
