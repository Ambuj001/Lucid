...
The **Axis Flipkart** is a premium **Credit** card issued by **Axis Bank** running on the **RUPAY** network. Below are the verified fee structures, reward policies, exclusions, and card terms.

## 💳 Fee and Waiver Structure
- **Joining Fee:** ₹500.00 + GST
- **Annual Fee:** ₹500.00 + GST
- **Annual Fee Spend Waiver Threshold:** Spends exceeding ₹350,000.00 in the previous card anniversary year waive the subsequent year's fee.
...
| :--- | :--- | :--- | :--- |
| **Default / All Other Spends** | `DEFAULT` | **1.5%** | No Cap |
| Retail & E-commerce (Amazon, Flipkart) | `5310` | **5.0%** | No Cap |
| Dining, Restaurants & Food Delivery | `5812` | **4.0%** | No Cap |

### ⚠️ Crucial Terms and Marketing Gimmicks
- 1.5% cashback on other spends.
- 💰 5% cashback on Flipkart purchases. Capping: None.
- 🍔 4% cashback on Swiggy, PVR, Uber. Capping: None.
